...
(defcustom hypermodern/ui-theme 'base16-ono-sendai-tuned
...
(defconst hypermodern/ui--style-presets
  ...
  '(
    ...
    (:name "Minimal / Tuned" :theme base16-ono-sendai-tuned :density tight :signal minimal :font auto :alpha 100
           :glow off :pulse nil :halo off)

    ;; daily driver glow-up (still minimal, just intentional)
    (:name "Minimal / Tuned / Glow" :theme base16-ono-sendai-tuned :density tight :signal minimal :font auto :alpha 100
           :glow subtle :pulse t :halo auto)

    ;; neon control room (still disciplined: no confetti)
    (:name "Minimal / Tuned / Neon" :theme base16-ono-sendai-tuned :density tight :signal loud :font auto :alpha 97
    ...
    (:name "Ono-Sendai / Tuned (daily driver)" :theme base16-ono-sendai-tuned :density tight :signal minimal :font auto :alpha 100
           :glow subtle :pulse t :halo auto)
    ...
    (:name "Iosevka / Tight / Glow" :theme base16-ono-sendai-tuned :density tight :signal minimal :font iosevka :alpha 100
           :glow subtle :pulse t :halo auto)

    (:name "JetBrains / Normal / Glow" :theme base16-ono-sendai-tuned :density normal :signal normal :font jetbrains :alpha 100
           :glow subtle :pulse t :halo auto)

    (:name "Berkeley / Comfy / Glow" :theme base16-ono-sendai-tuned :density comfy :signal minimal :font berkeley :alpha 100
           :glow subtle :pulse t :halo auto)

    ;; writing + reading
    (:name "Writing / Comfy / Glow" :theme base16-ono-sendai-tuned :density comfy :signal minimal :font auto :alpha 100
           :writing t :glow subtle :pulse nil :halo auto)

    (:name "Cinema / Reading Mode" :theme base16-ono-sendai-tuned :density cinema :signal minimal :font auto :alpha 100
           :writing t :glow subtle :pulse nil :halo auto)
