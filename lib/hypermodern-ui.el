...
(defconst hypermodern/ui--font-presets
  '((auto
     :mono ("Berkeley Mono" "Iosevka Term" "Iosevka Fixed" "JetBrains Mono"
            "Fira Code" "Fira Mono" "Source Code Pro" "IBM Plex Mono" "Hack"
            "Cascadia Code" "Cascadia Mono" "Victor Mono" "Inconsolata"
            "SF Mono" "Monaco" "DejaVu Sans Mono")
     :variable ("Berkeley Mono" "Iosevka Aile" "Inter" "SF Pro Text"
                "IBM Plex Sans" "Noto Sans" "DejaVu Sans"))
    (berkeley
     :mono ("Berkeley Mono")
    ...
    (fira
     ...
     :variable ("Fira Sans" "Inter" "Noto Sans"))
    (source-code-pro
     :mono ("Source Code Pro" "Source Code Variable")
     :variable ("Source Sans Pro" "Inter" "Noto Sans"))
    (ibm-plex
     :mono ("IBM Plex Mono")
     :variable ("IBM Plex Sans" "Inter" "Noto Sans"))
    (cascadia
     :mono ("Cascadia Code" "Cascadia Mono")
     :variable ("Inter" "Noto Sans"))
    (hack
     :mono ("Hack")
     :variable ("Inter" "Noto Sans"))
    (victor-mono
...
;; ----------------------------
;; Gibson Quotes (aesthetic flavor)
;; ----------------------------
...
pipeorgans. adding machines. i got no idea why i'm here now."
...
no way human.")
  "Raw excerpts from William Gibson's Sprawl trilogy.")
