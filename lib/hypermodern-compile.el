...
;; comprehensive error regexes. No use-package here - init.el owns load order.
...
(defun hypermodern/compile--eat-exec (name buffer command)
  ...
  (unless (require 'eat nil t)
    (user-error "eat package required for terminal emulation"))
  (with-current-buffer
...
;; ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
;; // setup function // call from init.el
;; ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

(defun hypermodern/compile-setup ()
  "Set up compilation with eat backend and smart defaults.
Call this from init.el after loading compile and eat."
  ;; Wire up eat backend
  ...
  ;; ANSI colors (backup if eat isn't used)
  (require 'ansi-color)
